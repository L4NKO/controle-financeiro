...
if (isset($_POST['btnPesquisar'])) {
    ...
    $movs = $dao->FiltrarMovimento($tipo, $data_inicial, $data_final);
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <hr />
                <form method="post" action="cons_movimento.php">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" placeholder="Ex.: 01/01/2023" id="datainicial" name="data_inicial" value="<?= $data_inicial ?>" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Data final*</label>
                            <input type="date" class="form-control" placeholder="Ex.: 01/01/2023" id="datafinal" name="data_final" value="<?= $data_final ?>" />
                        </div>
                    </div>
                    <center>
